...
| `campaign` | list, view, create, edit, steps, senders, segments, preflight, test, start, stop, logs, pause-lead / resume-lead / lead-hold |
...
# One contact is away: hold their sequence without unsubscribing them
