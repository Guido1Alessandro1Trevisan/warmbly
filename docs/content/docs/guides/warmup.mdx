...
Shared pools only work if participants behave, so each mailbox accumulates a spam score from negative signals: complaints, spam-folder placement, bounces, and tampering with warmup mail it received, such as deleting it or flagging it as spam.
